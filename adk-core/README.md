...
`adk-core` provides the foundational abstractions for the Rust Agent Development Kit ([ADK-Rust](https://github.com/zavora-ai/adk-rust)). It defines the core traits and types that all other ADK crates build upon, including:
