...
- [x] 1. Foundation: Type Definitions & Store
  - [x] 1.1 Create standard properties type definitions
...
- [x] 3. Visual Components: Base & Palette
  ...
  - [x] 3.3 Create ActionPalette component
...
- [x] 24. Testing & Documentation
  - [x] 24.1 Create example workflow: Email Sentiment Analysis
    - Implement the use case from design doc
    - Test end-to-end execution
  
  - [x] 24.2 Update ADK Studio README
    - Document action node types
    - Add configuration examples
  
  - [x] 24.3 Add tooltips to all action node UI elements
  
  - [x] 24.4 Final UI polish pass
...
- [x] 35. Create n8n-Inspired Workflow Templates
  - [x] 35.1 Create template data structure for action node workflows
  ...
  - [x] 35.2 Template 1: AI-Powered Lead Generation
  ...
  - [x] 35.3 Template 2: Intelligent Email Marketing
  ...
  - [x] 35.4 Template 3: Social Media AI Content Creator
  ...
  - [x] 35.5 Template 4: AI Customer Support
  ...
  - [x] 35.6 Template 5: Intelligent Data Analysis & Reporting
  ...
  - [x] 35.7 Template 6: AI Invoice Processing
  ...
  - [x] 35.8 Template 7: AI Job Application Bot
  ...
  - [x] 35.9 Template 8: AI Newsletter Digest Creator
  ...
  - [x] 35.10 Template 9: E-commerce AI Order Intelligence
  ...
  - [x] 35.11 Template 10: AI-Powered Incident Response
  ...
  - [x] 35.12 Template 11: AI Code Review & QA
  ...
  - [x] 35.13 Template 12: AI Customer Onboarding Journey
  ...
  - [x] 35.14 Integrate templates into TemplateGallery
  ...
  - [x] 35.15 Add template documentation
    - README for each template explaining use case
    - Required API keys and environment variables
    - Customization guide
    - **Bonus**: Added TemplateWalkthroughModal for guided setup after template selection
